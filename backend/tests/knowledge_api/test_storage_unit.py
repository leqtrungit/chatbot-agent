...
class TestStoragePath:
    ...
    def test_storage_path_includes_org_id(self):
    ...
    def test_storage_path_preserves_extension(self):
    ...
    def test_storage_path_structure(self):
        ...
        with patch("app.knowledge.storage.get_settings") as mock_settings:
            ...
            # Should have structure: ..., uploads, {org_id}, {doc_id}.pdf
            assert "uploads" in parts
    ...
    def test_storage_path_different_orgs_different_paths(self):
